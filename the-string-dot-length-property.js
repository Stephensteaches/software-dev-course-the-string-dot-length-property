...
console.log(stringOne + " has the length of " + lengthOne);
console.log(stringTwo + " has the length of " + lengthTwo);
console.log(stringThree + " has the length of " + lengthThree);
